...
public class EditUser extends javax.swing.JFrame {
    ...
    public EditUser(Utilisateur u,UserController usercontroller) {
        this.usercontroller = usercontroller;
        initComponents();
        
        this.idUtilisateur = u.getIdUtilisateur();
        this.ancienMotDePasse = u.getMotDePasseUser();
        this.fieldPrenom.setText(u.getPrenomUser());
        this.fieldNom.setText(u.getNomUser());
        this.fieldNumeroTelephone.setText(u.getTelephoneUser());
        this.fieldEmail.setText(u.getEmailUser());
        this.fieldAdresse.setText(u.getAdresseUser());
        this.fieldVille.setText(u.getVilleUser());
        this.fieldCodePostal.setText(u.getCodePostalUser());
        ...
        if (u.getFonctionUser().equals("Policier")) {
            ComboBoxFonction.setSelectedItem("Policier");
        }
        if (u.getFonctionUser().equals("Eleveur")) {
            ComboBoxFonction.setSelectedItem("Eleveur");
        }
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1250, 711));
        setResizable(false);
        ...
        ICAD.setName(""); // NOI18N
        ICAD.setText("ICAD - Modification d'un utilisateur");
    ...
    private void btnValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValiderActionPerformed
        ...
        String motDePasseSaisi = new String(fieldMotDePasse.getPassword());
        ...
        usercontroller.ModifierUtilisateur(this.idUtilisateur, this.ancienMotDePasse, nomSaisi, prenomSaisi, numeroTelephoneSaisi, motDePasseSaisi, emailSaisi, adresseSaisi, villeSaisi, codePostalSaisi, fonctionSaisi);
